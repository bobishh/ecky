...
fn scan_expr_for_params_get(
    ...
    if let Expr::Call(call) = expr {
        ...
        for kw in &call.keywords {
            scan_expr_for_params_get(&kw.value, fields, params);
        }
        ...
        for e in &l.elts {
            scan_expr_for_params_get(e, fields, params);
        }
...
fn scan_stmt_for_params_get(
    ...
    match stmt {
        ...
        Stmt::For(f) => {
            for s in &f.body {
                scan_stmt_for_params_get(s, fields, params);
            }

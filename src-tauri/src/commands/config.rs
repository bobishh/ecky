...
#[tauri::command]
pub async fn save_config(config: crate::models::Config, state: State<'_, AppState>, app: AppHandle) -> Result<(), String> {
...
#[tauri::command]
pub async fn list_models(provider: String, api_key: String, base_url: String) -> Result<Vec<String>, String> {
